		...
		<div className="md:w-96 sm:w-80 w-64 ml-2 mt-2 border h-full rounded-lg bg-[#030027] text-white flex flex-col justify-center items-center">
			{visible && (
				<div className="h-40 w-full flex flex-col items-center justify-center">
					<h1 className="md:text-lg text-base text-white text-center font-bold ">
						{props.name}
					</h1>
					<p>on {props.date}</p>
				</div>
			...
			{!visible && (
				<div className="h-40 w-full rounded-t-lg flex flex-col items-center">
					<div className="h-5/6 flex flex-col items-center w-5/6">
						<div className="flex justify-center items-center md:text-xl sm:text-lg text-base h-1/3 font-bold">
							Users
						</div>
						<div className="flex flex-col justify-center text-base items-center h-2/3 w-full mt-2">
							{users.map((user) => {
								return <h1 className="ml-2">{user.name}</h1>;
							})}
						</div>
					</div>
					<div className="md:text-base text-sm h-1/6 font-bold">
